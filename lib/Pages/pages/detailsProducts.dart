...
Widget ListRecomendado() {
  ...
  return Flexible(
    child: ListView.builder(
      itemCount: 5,
      itemBuilder: (_, index) {
        String image = recomendado[random_list[index]]["image"];
        String titulo = recomendado[random_list[index]]["titulo"];
        String subtitulo = recomendado[random_list[index]]["subtitulo"];
        String calif = recomendado[random_list[index]]["calificacion"];
        String precio = recomendado[random_list[index]]["precio"];
        String califtotal =
            recomendado[random_list[index]]["clasificacion_total"];
        String medida = recomendado[random_list[index]]["medida"];
